...
def render_frame(frame_idx):
    ...
    # Status badges
    draw_rounded_rect(draw, (W - 510, 26, W - 280, 58), 10, fill="#25282e", outline="#353840", width=1)
    draw.text((W - 495, 33), "● 1080p HD  •  180ms Latência", fill="#10b981", font=font_sub)
    
    draw_rounded_rect(draw, (W - 265, 26, W - 140, 58), 10, fill="#25282e", outline="#353840", width=1)
    draw.text((W - 250, 33), "2 Participantes", fill="#e2e8f0", font=font_sub)
    
    draw.text((W - 115, 33), "10:45 AM", fill="#94a3b8", font=font_sub)
    ...
    # 2. Participant Video Tiles
    tile_y1, tile_y2 = 82, 690
    
    # Sarah Tile
    f_idx = (frame_idx % 360) + 1
...
def main():
    output_mp4 = "/Users/davidjunior/dev/parrot/landingpage/public/videos/parrot-meeting-demo.mp4"
    audio_path = "/tmp/parrot_tts/meeting_dialogue.mp3"
    ...
    print(f"Starting video encoding: {TOTAL_FRAMES} frames ({DURATION}s at {FPS}fps)...")
    ...
    for idx in range(TOTAL_FRAMES):
        ...
        if idx % 90 == 0:
            ...
            print(f"Rendered {idx}/{TOTAL_FRAMES} frames ({pct:.1f}%)...")
