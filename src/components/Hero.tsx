...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative min-h-[88vh] flex flex-col justify-center items-center pt-28 pb-16 sm:pt-32 sm:pb-20 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 w-full">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/80 border border-slate-200 text-xs font-semibold text-slate-600 shadow-sm mb-7 backdrop-blur">
          <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
          Uma ferramenta feita para aproximar pessoas.
        </div>

        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold tracking-[-0.045em] text-slate-950 font-sans leading-[1.05] mb-6">
          Fale no seu idioma.{' '}
          <span className="text-emerald-600 block lg:inline">
            A chamada escuta no dela.
          </span>
        </h1>

        <p className="max-w-2xl mx-auto text-base sm:text-lg leading-relaxed text-slate-600 mb-9">
